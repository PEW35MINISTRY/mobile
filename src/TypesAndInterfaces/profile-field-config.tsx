...
export const SIGNUP_PROFILE_FIELDS_STUDENT:InputField[] = [
    ...
    new InputField({title: 'Gender', field: 'gender', type: InputType.SELECT_LIST, required: true, selectOptionList: Object.values(GenderEnum)}),
    new InputField({title: 'Date of Birth', field: 'dateOfBirth', type: InputType.DATE, required: true, validationRegex: DATE_REGEX, validationMessage: 'Required, Must be between the ages of 13 and 18' }),
];
